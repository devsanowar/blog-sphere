...
class WebsiteSettingController extends Controller
{
    ...
    public function websiteSettingUpdate(Request $request){
        ...
        $request->validate([
            'website_logo' => 'nullable|image|mimes:jpeg,png,jpg,svg|max:200',
            'website_favicon' => 'nullable|image|mimes:jpeg,png,jpg,svg|max:200',
            'website_footer_logo' => 'nullable|image|mimes:jpeg,png,jpg,svg|max:200',
