...
<nav class="navbar">
    <div class="col-12">
        ...
        <ul class="nav navbar-nav navbar-left">
            ...
            <li><a href="{{ route('sendus.index') }}" class="inbox-btn hidden-sm-down" data-close="true"><i class="zmdi zmdi-email"></i></a></li>
                ...
                <ul class="dropdown-menu slideDown">
                    <li class="body">
                        <ul class="menu">
                            ...
                            <li><a href="{{route('team.contact')}}"><i class="zmdi zmdi-accounts-list"></i><span>Contacts</span></a></li>
            ...
            <li>
                <a href="{{ url('/') }}" class="inbox-btn hidden-sm-down" target="_blank" data-close="true">
