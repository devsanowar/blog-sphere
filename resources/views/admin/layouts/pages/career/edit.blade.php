            ...
            <div class="col-lg-12 col-md-12 col-sm-12 mt-3">
                <div class="card">
                    <div class="card-header">
                        <h4 class="text-uppercase"> Edit Job Post <span><a href="{{ route('career.index') }}" class="btn btn-primary right">All Job Post</a></span></h4>

                    </div>
                    <div class="body">
                        <form class="form-horizontal" action="{{ route('career.update', $career->id) }}"
                            ...
                            <div class="col-lg-12 col-md-12 col-sm-8 col-xs-7 mb-3">
                                ...
                                <div class="form-group">
                                    <div class="" style="border: 1px solid #ccc">
                                        <input type="text" name="job_title" class="form-control @error('job_title') invalid @enderror" value="{{ $career->job_title }}">
                                    </div>
                            ...
                            <div class="col-lg-12 col-md-12 col-sm-8 col-xs-7 mb-3">
                                ...
                                <div class="form-group">
                                    <div class="" style="border: 1px solid #ccc">
                                        <input type="text" name="location" class="form-control @error('location') invalid @enderror" value="{{ $career->location }}">
                                    </div>
                            ...
                            <div class="col-lg-12 col-md-12 col-sm-8 col-xs-7 mb-3">
                                ...
                                <div class="form-group">
                                    <div class="" style="border: 1px solid #ccc">
                                        <input type="text" name="salary" class="form-control @error('salary') invalid @enderror" value="{{ $career->salary }}">
                                    </div>
                            ...
                            <div class="col-lg-12 col-md-12 col-sm-8 col-xs-7 mb-3">
                                ...
                                <div class="form-group">
                                    <div class="" style="border: 1px solid #ccc">
                                        <textarea name="description" class="form-control ckeditor @error('description') invalid @enderror" id="" cols="30" rows="10">{{ $career->description }}</textarea>
                                    </div>
                            ...
                            <div class="col-lg-12 col-md-12 col-sm-8 col-xs-7 mb-3">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea name="responsibilities" class="form-control ckeditor @error('responsibilities') invalid @enderror"
                                              id="" cols="30" rows="10">{{ $career->responsibilities }}</textarea>
                                    </div>
                            ...
                            <div class="col-lg-12 col-md-12 col-sm-8 col-xs-7 mb-3">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea name="others_requirements" class="form-control ckeditor @error('others_requirements') invalid @enderror"
                                              id="" cols="30" rows="5">{{ $career->others_requirements }}</textarea>
                                    </div>
                            ...
                            <div class="col-lg-12 col-md-12 col-sm-8 col-xs-7 mb-3">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea name="educational_requirements" class="form-control ckeditor @error('educational_requirements') invalid @enderror"
                                              id="" cols="30" rows="5">{{ $career->educational_requirements }}</textarea>
                                    </div>
                            ...
                            <div class="col-lg-12 col-md-12 col-sm-8 col-xs-7 mb-3">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea name="experience_requirements" class="form-control ckeditor @error('experience_requirements') invalid @enderror"
                                              id="" cols="30" rows="5">{{ $career->experience_requirements }}</textarea>
                                    </div>
                                ...
                                <div class="form-group">
                                    <div class="" style="border: 1px solid #ccc">
                                        <select name="is_active" class="form-control show-tick">
                                            <option {{ $career->is_active == 1 ? 'selected' : '' }} value="1">Active</option>
                                            <option {{ $career->is_active == 0 ? 'selected' : '' }} value="0">DeActive</option>
                                        </select>
                                    </div>
                                </div>
                            </div>
