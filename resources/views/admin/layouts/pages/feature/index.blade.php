        ...
        <div class="col-lg-12 col-md-12 col-sm-12 mt-3">
            <div class="card">
                <div class="card-header">
                    <h4> All Feature <span><a href="{{ route('feature.create') }}" class="btn btn-primary right">+ Add Feature</a></span> </h4>
                </div>
                <div class="body table-responsive">
                    <table class="table table-bordered table-striped table-hover js-basic-example dataTable">
                        ...
                        <tr>
                            ...
                            <td><img src="{{ asset($feature->image) }}" alt="Feature Image" width="40"></td>
                            <td style="text-align: left">{{ $feature->feature_title }}</td>
                            <td>
                            ...
                            <td>
                                <a href="{{ route('feature.edit', $feature->id) }}" class="btn btn-warning">  <i class="material-icons text-white">edit</i></a>
