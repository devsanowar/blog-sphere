        ...
        <div class="col-lg-12 col-md-12 col-sm-12 mt-3">
            <div class="card">
                <div class="card-header">
                    <h4 class="text-uppercase"> Create Feature <span><a href="{{ route('feature.index') }}" class="btn btn-primary right">All Feature</a></span></h4>

                </div>
                <div class="body">
                    <form class="form-horizontal" action="{{ route('feature.store') }}"
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-8 col-xs-7 mb-3">
                            ...
                            <div class="form-group">
                                <div class="" style="border: 1px solid #ccc">
                                    <input type="text" id="brand_id" name="feature_title" class="form-control"
