            ...
            <div class="card">
                ...
                <div class="body">
                    <form class="form-horizontal" action="{{ route('slider.store') }}"
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-8 col-xs-7 mb-3">
                            <label for="slider_sub_title_id"><b>Slider Sub-Title</b></label>
                            <div class="form-group">
                                <div class="" style="border: 1px solid #ccc">
                                    <input type="text" id="slider_sub_title_id" name="slider_sub_title" class="form-control">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-8 col-xs-7 mb-3">
                            ...
                            <div class="form-group">
                                <div class="" style="border: 1px solid #ccc">
                                    <textarea type="text" id="" name="slider_description" class="para form-control"></textarea>
                                </div>
                            </div>
                        </div>
