                ...
                <div class="card">
                    ...
                    <div class="body">
                        <form class="form-horizontal" action="{{ route('website_footer_info.update', $website_setting->id) }}"
                            ...
                            <div class="col-lg-12 col-md-12 col-sm-8 col-xs-7 mb-3">
                                <label for="web_address"><b>Web Address</b></label>
                                <div class="form-group">
                                    <div class="" style="border: 1px solid #ccc">
                                        <input type="text" id="web_address" name="web_address" class="form-control"
                                               placeholder="Enter website Address "
                                               value="{{ $website_setting->web_address }}">
                                    </div>
                                </div>
                            </div>

                            <div class="col-lg-12 col-md-12 col-sm-8 col-xs-7 mb-3">
                                <label for="address"><b>Address (Corporate Office)</b></label>
                                <div class="form-group">
                                    <div class="" style="border: 1px solid #ccc">
                            ...
                            <div class="col-lg-12 col-md-12 col-sm-8 col-xs-7 mb-3">
                                <label for="branch_address"><b>Address (Branch Office)</b></label>
                                <div class="form-group">
                                    <div class="" style="border: 1px solid #ccc">
                                        <input type="text" id="branch_address" name="branch_address" class="form-control"
                                            placeholder="Enter your address" value="{{ $website_setting->branch_address }}">
                                    </div>
                                </div>
                            </div>
