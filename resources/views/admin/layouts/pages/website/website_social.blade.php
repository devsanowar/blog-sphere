                            ...
                            <div class="form-group">
                                <div class="" style="border: 1px solid #ccc">
                                    <input type="text" id="facebook_url" class="form-control"
                                        placeholder="Enter facebook url " name="facebook_url" value="{{ $social_icon_setting->facebook_url }}">
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="form-group">
                                <div class="" style="border: 1px solid #ccc">
                                    <input type="text" id="linkedin_url" class="form-control"
                                        placeholder="Enter linkedin url " name="linkedin_url" value="{{ $social_icon_setting->linkedin_url }}">
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="form-group">
                                <div class="" style="border: 1px solid #ccc">
                                    <input type="text" id="instagram_url" class="form-control"
                                        placeholder="Enter Instagram url " name="instagram_url" value="{{ $social_icon_setting->instagram_url }}" >
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="form-group">
                                <div class="" style="border: 1px solid #ccc">
                                    <input type="text" id="twitter_url" class="form-control"
                                        placeholder="Enter twitter url" name="twitter_url" value="{{ $social_icon_setting->twitter_url }}">
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="form-group">
                                <div class="" style="border: 1px solid #ccc">
                                    <input type="text" id="youtube_url" class="form-control"
                                        placeholder="Enter youtube url" name="youtube_url" value="{{ $social_icon_setting->youtube_url }}">
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="form-group">
                                <div class="" style="border: 1px solid #ccc">
                                    <input type="text" id="pinterest_url" class="form-control"
                                        placeholder="Enter pinterest url " name="pinterest_url" value="{{ $social_icon_setting->pinterest_url }}">
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="form-group">
                                <div class="" style="border: 1px solid #ccc">
                                    <input type="text" id="googleplus_url" class="form-control"
                                        placeholder="Enter googleplus url " name="googleplus_url" value="{{ $social_icon_setting->googleplus_url }}">
                                </div>
                            </div>
                        </div>
