            ...
            <div class="col-lg-12 col-md-12 col-sm-12 mt-3">
                <div class="card">
                    <div class="card-header">
                        <h4 class="text-uppercase"> Create Blog <span><a href="{{ route('blog.index') }}" class="btn btn-primary right">All Blog</a></span></h4>
                    </div>

                    <div class="body">
                        <form class="form-horizontal" action="{{ route('blog.store') }}"
                            ...
                            <div class="col-lg-12 col-md-12 col-sm-8 col-xs-7 mb-3">
                                ...
                                <div class="form-group">
                                    <div class="" style="border: 1px solid #ccc">
                                        <select name="menu_id" class="form-control show-tick">
                            ...
                            <div class="col-lg-12 col-md-12 col-sm-8 col-xs-7 mb-3">
                                <label for="brand_id"><b>Blog Category*</b></label>
                                <div class="form-group">
                                    <div class="" style="border: 1px solid #ccc">
                            ...
                            <div class="col-lg-12 col-md-12 col-sm-8 col-xs-7 mb-3">
                                ...
                                <div class="form-group">
                                    <div class="" style="border: 1px solid #ccc">
                                        <textarea name="blog_content" id="ckeditor" class="@error('blog_content') invalid @enderror"></textarea>
                                    </div>
                                    @error('blog_content')
                                    <div class="text-danger">{{ $message }}</div>
                                    @enderror
