        ...
        <div class="col-lg-12 col-md-12 col-sm-12 mt-4">
            <div class="card">
                <div class="card-header">
                    <h4 class="text-uppercase"> All Reviews<span><a href="{{ route('review.create') }}" class="btn btn-primary text-white text-uppercase text-bold right">
                        + Add Review
                   </a></span></h4>
                </div>
                <div class="body">
                    <table class="table table-bordered table-striped table-hover js-basic-example dataTable">
                        ...
                        <tbody>
                            ...
                            <tr>
								...
								<td>{!! Str::words($review->review, 3, '...') !!}</td>
